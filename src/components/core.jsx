...
export default function core() {
  ...
  return (
    <div className=' bg-white'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2   lg:grid-cols-4 gap-5 md:gap-20 pb-[20px]'>
        ...
        <div className='px-[20px] md:px-[40px] overflow-hidden flex flex-col md:flex-col justify-center items-center md:gap-2 pb-8 md:pb-8 lg:pb-0'>
            ...
            <div className ='px-[20px] md:px-[40px] overflow-hidden flex flex-row md:flex-row justify-center items-center'>
                 <img src={image2} alt="" className='h-[200px] md:w-[600px] md:h-[569px]'/>
                 <img src={image3} alt="" className='h-[200px] md:w-[600px] md:h-[569px]'/>
            </div>
        </div>
    </div>
  )
