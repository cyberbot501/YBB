...
const social = [
    ...
    {
        image: img6,
        link: "@fnfeefoundation001@yahoo.com",
    },
...
const Form = () => {
  return (
    ...
    <div className='pt-[40px] flex flex-col xl:flex-row justify-center items-center px-[10px] md:px-20 bg-[#ffffff] gap-10 xl:gap-[180px] md:pb-[40px]  '>
        <div className='bg-[#9B2B87] flex flex-col justify-center items-center  xl:items-start w-full xl:w-[422px] h-[635px] space-y-[40px] md:gap-0 px-5 md:px-20 xl:pt-20  rounded-[20px]'>
           ...
           <p className='font-normal text-[16px]'>Reach out to us via the following means</p>
            ...
            {social.map((item, index) => (
                <label htmlFor="instagram" index='key' className='flex flex-row gap-10 items-center pt-[10px] cursor-pointer'>
        ...
        <form className='flex flex-col gap-3 xl:gap-7 pb-[10px] xl:px-0'>
            ...
            <button className='w-full xl:w-[546px] h-[72px] bg-[#9B2B87] outline-none text-white  rounded-[10px] px-4 '>
                Submit
            </button>
        </form>
    </div>
