...
export default function mandv() {
  return (
    <div className='flex flex-col overflow-hidden '>
         ...
         <div className='flex flex-row px-[20px] md:px-[40px] justify-center items-start md:items-start relative bottom-[300px] md:bottom-[420px] md:gap-[290px] overflow-hidden'>
